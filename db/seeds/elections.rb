    ...
    module MaoriElections
      ...
      [
        { voting_commenced_on: Date.new(1868,  4, 15), voting_finished_on: Date.new(1868,  5,  6), 
                         parliament: Parliament.find_by(ordinal_number: 4), note: 'First Maori Election' },
